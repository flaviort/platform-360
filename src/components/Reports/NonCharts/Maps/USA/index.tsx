...
export default function MapUSA({
    ...
    const getValueRanges = () => {
        ...
        return {
            ...
            max: maxValue,
            categories: [
                { min: minValue, max: minValue + rangePerCategory, color: '#ADD8F6' }, // lightblue
                { min: minValue + rangePerCategory + 0.01, max: minValue + (rangePerCategory * 2), color: '#D8E164' }, // yellow
                { min: minValue + (rangePerCategory * 2) + 0.01, max: minValue + (rangePerCategory * 3), color: '#E18E36' }, // orange
                { min: minValue + (rangePerCategory * 3) + 0.01, max: maxValue, color: '#E13639' } // red
            ]
        }
    }
    ...
    const getStateColor = (stateId: string, stateName: string): string => {
        const stateData = data.find(item => {
            // Extract state code from geo field (e.g., "US-AZ" -> "AZ")
            const stateCode = item.geo ? item.geo.replace('US-', '') : ''
            return stateCode === stateId || item.name === stateName
        })
        ...
        return '#E5E5E5' // default gray for states with no data
    }
    ...
    // Check if a state has data (value > 0)
    const hasData = (stateId: string, stateName: string) => {
        const stateData = data.find(item => {
            // Extract state code from geo field (e.g., "US-AZ" -> "AZ")
            const stateCode = item.geo ? item.geo.replace('US-', '') : ''
            return stateCode === stateId || item.name === stateName
    ...
    // Handle mouse enter/leave for SVG paths (states)
    const handleStateMouseEnter = (e: React.MouseEvent<SVGPathElement>) => {
        ...
        // Find the corresponding data for this state
        const stateData = data.find(item => {
            // Extract state code from geo field (e.g., "US-AZ" -> "AZ")
            const stateCode = item.geo ? item.geo.replace('US-', '') : ''
            return stateCode === stateId || item.name === stateName
        ...
        // Only show tooltip if the state has data
            ...
            >
                {isHovering && hoveredState && (
                    ...
                    >
                        ...
                        */}
                        ...
                        <p className='text-16'>
                            State: {hoveredState.name}<br />
                            <strong>Count: {hoveredState.value}</strong>
                        </p>
                    </div>
                )}
                ...
                >
                    <path
                        ...
                        data-id='MA'
                        className={!hasData('MA', 'Massachusetts') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MA', 'Massachusetts') }}
                    ...
                    <path
                        ...
                        data-name='Minnesota'
                        data-id='MN'
                        className={!hasData('MN', 'Minnesota') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MN', 'Minnesota') }}
                    ...
                    <path
                        ...
                        data-name='Montana'
                        data-id='MT'
                        className={!hasData('MT', 'Montana') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MT', 'Montana') }}
                    ...
                    <path
                        ...
                        data-id='ND'
                        className={!hasData('ND', 'North Dakota') ? styles.disabled : ''}
                        style={{ fill: getStateColor('ND', 'North Dakota') }}
                    ...
                    <path
                        ...
                        data-name='Hawaii'
                        data-id='HI'
                        className={!hasData('HI', 'Hawaii') ? styles.disabled : ''}
                        style={{ fill: getStateColor('HI', 'Hawaii') }}
                    ...
                    <path
                        ...
                        data-name='Idaho'
                        data-id='ID'
                        className={!hasData('ID', 'Idaho') ? styles.disabled : ''}
                        style={{ fill: getStateColor('ID', 'Idaho') }}
                    ...
                    <path
                        ...
                        data-id='WA'
                        className={!hasData('WA', 'Washington') ? styles.disabled : ''}
                        style={{ fill: getStateColor('WA', 'Washington') }}
                    ...
                    <path
                        ...
                        data-name='Arizona'
                        data-id='AZ'
                        className={!hasData('AZ', 'Arizona') ? styles.disabled : ''}
                        style={{ fill: getStateColor('AZ', 'Arizona') }}
                    ...
                    <path
                        ...
                        data-id='CA'
                        className={!hasData('CA', 'California') ? styles.disabled : ''}
                        style={{ fill: getStateColor('CA', 'California') }}
                    ...
                    <path
                        ...
                        data-name='Colorado'
                        data-id='CO'
                        className={!hasData('CO', 'Colorado') ? styles.disabled : ''}
                        style={{ fill: getStateColor('CO', 'Colorado') }}
                    ...
                    <path
                        ...
                        data-name='Nevada'
                        data-id='NV'
                        className={!hasData('NV', 'Nevada') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NV', 'Nevada') }}
                    ...
                    <path
                        ...
                        data-id='NM'
                        className={!hasData('NM', 'New Mexico') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NM', 'New Mexico') }}
                    ...
                    <path
                        ...
                        data-name='Oregon'
                        data-id='OR'
                        className={!hasData('OR', 'Oregon') ? styles.disabled : ''}
                        style={{ fill: getStateColor('OR', 'Oregon') }}
                    ...
                    <path
                        ...
                        data-name='Utah'
                        data-id='UT'
                        className={!hasData('UT', 'Utah') ? styles.disabled : ''}
                        style={{ fill: getStateColor('UT', 'Utah') }}
                    ...
                    <path
                        ...
                        data-name='Wyoming'
                        data-id='WY'
                        className={!hasData('WY', 'Wyoming') ? styles.disabled : ''}
                        style={{ fill: getStateColor('WY', 'Wyoming') }}
                    ...
                    <path
                        ...
                        data-name='Arkansas'
                        data-id='AR'
                        className={!hasData('AR', 'Arkansas') ? styles.disabled : ''}
                        style={{ fill: getStateColor('AR', 'Arkansas') }}
                    ...
                    <path
                        ...
                        data-name='Iowa'
                        data-id='IA'
                        className={!hasData('IA', 'Iowa') ? styles.disabled : ''}
                        style={{ fill: getStateColor('IA', 'Iowa') }}
                    ...
                    <path
                        ...
                        data-name='Kansas'
                        data-id='KS'
                        className={!hasData('KS', 'Kansas') ? styles.disabled : ''}
                        style={{ fill: getStateColor('KS', 'Kansas') }}
                    ...
                    <path
                        ...
                        data-name='Missouri'
                        data-id='MO'
                        className={!hasData('MO', 'Missouri') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MO', 'Missouri') }}
                    ...
                    <path
                        ...
                        data-name='Nebraska'
                        data-id='NE'
                        className={!hasData('NE', 'Nebraska') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NE', 'Nebraska') }}
                    ...
                    <path
                        ...
                        data-name='Oklahoma'
                        data-id='OK'
                        className={!hasData('OK', 'Oklahoma') ? styles.disabled : ''}
                        style={{ fill: getStateColor('OK', 'Oklahoma') }}
                    ...
                    <path
                        ...
                        data-id='SD'
                        className={!hasData('SD', 'South Dakota') ? styles.disabled : ''}
                        style={{ fill: getStateColor('SD', 'South Dakota') }}
                    ...
                    <path
                        ...
                        data-name='Louisiana'
                        data-id='LA'
                        className={!hasData('LA', 'Louisiana') ? styles.disabled : ''}
                        style={{ fill: getStateColor('LA', 'Louisiana') }}
                    ...
                    <path
                        ...
                        data-name='Texas'
                        data-id='TX'
                        className={!hasData('TX', 'Texas') ? styles.disabled : ''}
                        style={{ fill: getStateColor('TX', 'Texas') }}
                    ...
                    <path
                        ...
                        data-id='CT'
                        className={!hasData('CT', 'Connecticut') ? styles.disabled : ''}
                        style={{ fill: getStateColor('CT', 'Connecticut') }}
                    ...
                    <path
                        ...
                        data-id='NH'
                        className={!hasData('NH', 'New Hampshire') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NH', 'New Hampshire') }}
                    ...
                    <path
                        ...
                        data-id='RI'
                        className={!hasData('RI', 'Rhode Island') ? styles.disabled : ''}
                        style={{ fill: getStateColor('RI', 'Rhode Island') }}
                    ...
                    <path
                        ...
                        data-name='Vermont'
                        data-id='VT'
                        className={!hasData('VT', 'Vermont') ? styles.disabled : ''}
                        style={{ fill: getStateColor('VT', 'Vermont') }}
                    ...
                    <path
                        ...
                        data-name='Alabama'
                        data-id='AL'
                        className={!hasData('AL', 'Alabama') ? styles.disabled : ''}
                        style={{ fill: getStateColor('AL', 'Alabama') }}
                    ...
                    <path
                        ...
                        data-name='Florida'
                        data-id='FL'
                        className={!hasData('FL', 'Florida') ? styles.disabled : ''}
                        style={{ fill: getStateColor('FL', 'Florida') }}
                    ...
                    <path
                        ...
                        data-name='Georgia'
                        data-id='GA'
                        className={!hasData('GA', 'Georgia') ? styles.disabled : ''}
                        style={{ fill: getStateColor('GA', 'Georgia') }}
                    ...
                    <path
                        ...
                        data-id='MS'
                        className={!hasData('MS', 'Mississippi') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MS', 'Mississippi') }}
                    ...
                    <path
                        ...
                        data-id='SC'
                        className={!hasData('SC', 'South Carolina') ? styles.disabled : ''}
                        style={{ fill: getStateColor('SC', 'South Carolina') }}
                    ...
                    <path
                        ...
                        data-name='Illinois'
                        data-id='IL'
                        className={!hasData('IL', 'Illinois') ? styles.disabled : ''}
                        style={{ fill: getStateColor('IL', 'Illinois') }}
                    ...
                    <path
                        ...
                        data-name='Indiana'
                        data-id='IN'
                        className={!hasData('IN', 'Indiana') ? styles.disabled : ''}
                        style={{ fill: getStateColor('IN', 'Indiana') }}
                    ...
                    <path
                        ...
                        data-name='Kentucky'
                        data-id='KY'
                        className={!hasData('KY', 'Kentucky') ? styles.disabled : ''}
                        style={{ fill: getStateColor('KY', 'Kentucky') }}
                    ...
                    <path
                        ...
                        data-id='NC'
                        className={!hasData('NC', 'North Carolina') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NC', 'North Carolina') }}
                    ...
                    <path
                        ...
                        data-name='Ohio'
                        data-id='OH'
                        className={!hasData('OH', 'Ohio') ? styles.disabled : ''}
                        style={{ fill: getStateColor('OH', 'Ohio') }}
                    ...
                    <path
                        ...
                        data-name='Tennessee'
                        data-id='TN'
                        className={!hasData('TN', 'Tennessee') ? styles.disabled : ''}
                        style={{ fill: getStateColor('TN', 'Tennessee') }}
                    ...
                    <path
                        ...
                        data-name='Virginia'
                        data-id='VA'
                        className={!hasData('VA', 'Virginia') ? styles.disabled : ''}
                        style={{ fill: getStateColor('VA', 'Virginia') }}
                    ...
                    <path
                        ...
                        data-name='Wisconsin'
                        data-id='WI'
                        className={!hasData('WI', 'Wisconsin') ? styles.disabled : ''}
                        style={{ fill: getStateColor('WI', 'Wisconsin') }}
                    ...
                    <path
                        ...
                        data-id='WV'
                        className={!hasData('WV', 'West Virginia') ? styles.disabled : ''}
                        style={{ fill: getStateColor('WV', 'West Virginia') }}
                    ...
                    <path
                        ...
                        data-name='Delaware'
                        data-id='DE'
                        className={!hasData('DE', 'Delaware') ? styles.disabled : ''}
                        style={{ fill: getStateColor('DE', 'Delaware') }}
                    ...
                    <path
                        ...
                        data-id='DC'
                        className={!hasData('DC', 'District of Columbia') ? styles.disabled : ''}
                        style={{ fill: getStateColor('DC', 'District of Columbia') }}
                    ...
                    <path
                        ...
                        data-name='Maryland'
                        data-id='MD'
                        className={!hasData('MD', 'Maryland') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MD', 'Maryland') }}
                    ...
                    <path
                        ...
                        data-id='NJ'
                        className={!hasData('NJ', 'New Jersey') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NJ', 'New Jersey') }}
                    ...
                    <path
                        ...
                        data-name='New York'
                        data-id='NY'
                        className={!hasData('NY', 'New York') ? styles.disabled : ''}
                        style={{ fill: getStateColor('NY', 'New York') }}
                    ...
                    <path
                        ...
                        data-id='PA'
                        className={!hasData('PA', 'Pennsylvania') ? styles.disabled : ''}
                        style={{ fill: getStateColor('PA', 'Pennsylvania') }}
                    ...
                    <path
                        ...
                        data-name='Maine'
                        data-id='ME'
                        className={!hasData('ME', 'Maine') ? styles.disabled : ''}
                        style={{ fill: getStateColor('ME', 'Maine') }}
                    ...
                    <path
                        ...
                        data-name='Michigan'
                        data-id='MI'
                        className={!hasData('MI', 'Michigan') ? styles.disabled : ''}
                        style={{ fill: getStateColor('MI', 'Michigan') }}
                    ...
                    <path
                        ...
                        data-name='Alaska'
                        data-id='AK'
                        className={!hasData('AK', 'Alaska') ? styles.disabled : ''}
                        style={{ fill: getStateColor('AK', 'Alaska') }}
            ...
            <div className={styles.legend}>
                ...
                <div className={styles.legendItems}>
                    {(() => {
                        ...
                        return ranges.categories.map((category, index) => (
                            <div key={index} className={styles.legendItem}>
                                ...
                                <span className={styles.legendText}>
                                    {Math.round(category.min)} - {Math.round(category.max)}
                                </span>
                            </div>
                        ))
                    })()}
                ...
                {data.map((item, index) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                //backgroundColor: getStateColor(item,name item.name)
                            }}
                        >
                            <p className='text-14'>
